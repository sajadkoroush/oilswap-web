...
import Astronot from 'public/images/home/lunar-bunny/astronaut-bunny.png'
...
const starsImage: CompositeImageProps = {
  ...
  attributes: [
    { src: 'logo-512', alt: 'Oil logo' },
    // { src: 'star-r', alt: '3D Star' },
    { src: 'Trade', alt: 'Oil Trade' },
  ],
}
      ...
      >
        <Flex flex="1" flexDirection="column">
          <Heading scale="xl" color="secondary" mb="24px">
            {t('The car is full of OIL.')}
          </Heading>
          <Heading scale="md" mb="24px">
            {t('Trade and earn a lot crypto on the most innovative decentralized exchange.')}
          </Heading>
          <Flex>
